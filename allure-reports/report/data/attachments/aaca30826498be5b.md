...
- Location: /__w/PlaywrightAllure/PlaywrightAllure/tests/e2e/newWindowSelectCheckboxRadiobutton.spec.ts:4:5
...
Call log:
  ...
  - waiting for locator('//h1[normalize-space(text())=\'QA Click Academy\']')
    ...
    at /__w/PlaywrightAllure/PlaywrightAllure/tests/e2e/newWindowSelectCheckboxRadiobutton.spec.ts:52:24
```
