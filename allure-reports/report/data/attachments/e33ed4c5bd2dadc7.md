...
Call log:
  - waiting for getByRole('option', { name: 'Part-Time Contract' })
  ...
  - rowgroup:
    ...
    - row " 0608 adsdfsdf sdfsdf  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " RK2345 Ahmed R Raju HR Manager (Deleted) Human Resources ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "RK2345"
