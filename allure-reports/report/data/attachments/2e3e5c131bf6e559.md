...
- separator
- text: Employee Name
- textbox "Type for hints...": Waelchi
- text: Employee Id
- textbox
  ...
  - rowgroup:
    ...
    - row " 0608 adsdfsdf sdfsdf  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " Employee aicha NicknameTest User HR Manager (Deleted) Human Resources ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "Employee"
      - cell "aicha NicknameTest"
      - cell "User"
